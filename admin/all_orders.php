                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-info">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped text-justify">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT users.*, users_orders.*, users_orders.payment_method
        FROM users 
...
;
                                            ...
                                            <?php 
                                                ...
                                                {
                                            ?>
                                            <td> <button type="button" class="btn btn-primary"><span class="fa fa-bars"
