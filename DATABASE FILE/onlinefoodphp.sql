...
INSERT INTO `dishes` (`p_id`, `rs_id`, `title`, `slogan`, `price`, `img`) VALUES
...
INSERT INTO `category` (`rs_id`, `c_id`, `title`, `email`, `phone`, `url`, `o_hr`, `c_hr`, `o_days`, `address`, `image`, `date`) VALUES
...
--
ALTER TABLE `dishes`
  MODIFY `p_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
